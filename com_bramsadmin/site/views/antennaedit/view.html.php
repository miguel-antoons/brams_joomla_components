...
class BramsAdminViewAntennaEdit extends HtmlView {
    ...
    private function setDocument() {
        ...
        $document->addStyleSheet('/components/com_bramsadmin/views/antennaedit/css/antennaedit.css');
        $document->addStyleSheet('/components/com_bramsadmin/views/antennaedit/css/bootstrap.min.css');
        $document->addStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css');
        $document->addScript('/components/com_bramsadmin/views/antennaedit/js/antennaedit.js');
