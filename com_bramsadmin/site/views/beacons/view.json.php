 ...
 * @since  0.6.1
 */
class BramsAdminViewBeacons extends HtmlView {
    /**
    ...
    /**
     * Function is the entrypoint to delete a beacon. It calls the
     * beacon delete method from the model and returns a json response
     * to front-end.
     *
     * @since 0.6.1
     */
    public function delete() {
        ...
        if (($model->deleteBeacon($id)) === -1) {
            return;
        }

        // if everything goes well, return a validation message to front-end
        echo new JResponseJson(
            array(('message') => 'Beacon with id ' . $id . ' has been deleted.')
        );
    }
    ...
    public function getAll() {
        ...
        echo new JResponseJson($beacons);
    }
}
