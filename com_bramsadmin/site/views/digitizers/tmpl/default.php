...
<div class="container custom_container container_margin">
    ...
    <div class='row'>
        <div class='col custom_col'>
            ...
            <h1>Digitizers</h1>
            <p>
                Click on one of the buttons on the right side column to edit or delete the digitizer.
            </p>
        </div>
    </div>
    <div class='row'>
        <div class='col custom_col'>
            <button
                type='button'
                class='customBtn new'
                onclick="window.location.href='/index.php?option=com_bramsadmin&view=digitizerEdit&id=';"
            >
            ...
            <table class='table'>
                ...
                <tr>
                    <th class='headerCol' onclick="sortTable(this, 'code')">
                        Digitizer Code <i id='sortIcon' class="fa fa-sort" aria-hidden="true"></i>
                    </th>
