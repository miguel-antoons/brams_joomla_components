...
class BramsAdminViewLocations extends HtmlView {
    ...
    function display($tpl = null) {
        ...
        $this->message = $model->location_messages[$message_id];
    ...
    private function setDocument() {
        ...
        $document->addStyleSheet('/components/com_bramsadmin/views/locations/css/locations.css');
        $document->addStyleSheet('/components/com_bramsadmin/views/locations/css/bootstrap.min.css');
        $document->addStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css');
        $document->addScript('https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js');
        $document->addScript('/components/com_bramsadmin/views/locations/js/locations.js');
    }
}
