...
<div class="container custom_container container_margin">
    ...
    <div class='row'>
        <div class='col custom_col'>
            ...
            <h1>Software</h1>
            <p>
                Click on one of the buttons on the right side column to edit or delete the software.
            </p>
        </div>
    </div>
    <div class='row'>
        <div class='col custom_col'>
            <button
                type='button'
                class='customBtn new'
                onclick="window.location.href='/index.php?option=com_bramsadmin&view=softwareEdit&id=';"
            >
            ...
            <table class='table'>
                ...
                <tr>
                    <th class='headerCol' onclick="sortTable(this, 'code')">
                        Software Code <i id='sortIcon' class="fa fa-sort" aria-hidden="true"></i>
                    </th>
