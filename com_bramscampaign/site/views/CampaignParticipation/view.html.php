...
class BramsCampaignViewCampaignParticipation extends HtmlView {
	...
	/**
	 * Display the CampaignParticipation view
	 *
	...
	private function setDocument() {
		...
		$wam->registerAndUseStyle('pageSpecific',   'components/com_bramscampaign/views/CampaignParticipation/css/CampaignParticipation.css');
		...
		$wam->registerAndUseScript('pageSpecific',  'components/com_bramscampaign/views/CampaignParticipation/js/CampaignParticipation.js');
	}
}
