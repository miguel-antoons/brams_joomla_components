(function (root, factory) {
    ...
    let has_VML; let has_canvas; let create_canvas_for; let add_shape_to; let clear_canvas; let shape_from_area;
    let canvas_style; let hex_to_decimal; let css3color; let is_image_loaded; let
        options_from_area;
    ...
    if (has_canvas) {
        ...
        add_shape_to = function (canvas, shape, coords, options, name) {
            let fill; let stroke; let opacity; let
                e;
            for (const i in coords) { coords[i] = parseInt(coords[i], 10); }
        ...
        clear_canvas = function (canvas) {
            // jquery1.8 + ie7
            const $html = $(`<div>${canvas.innerHTML}</div>`);
    ...
    $.fn.maphilight = function (opts) {
        ...
        return this.each(function () {
            let img; let wrap; let options; let map; let canvas; let canvas_always; let highlighted_shape; let usemap; let
                imgSrc;
            img = $(this);
            ...
            $(map).bind('alwaysOn.maphilight', () => {
                ...
                .bind('mouseover.maphilight focusin.maphilight', function (e) {
                    let shape; let area_options; const
                        area = e.target;
                ...
                .bind('mouseout.maphilight focusout.maphilight', (e) => { clear_canvas(canvas); });
