...
class Archive {
    ...
    public function __construct($cache=true) {
        ...
        $this->_cachePath = ROOT.DS.APP_DIR.DS.WEBROOT_DIR.DS.'img'.DS.'cache'.DS;
    ...
    public function getSpectrogram($dateTime, $system_code, $options = array()) {
        ...
        if (isset($options['fft'])) {
            $filename .= '_'.$options['fft'];
        }
        if (isset($options['overlap'])) {
            $filename .= '_'.$options['overlap'];
        }
        if (isset($options['color_min'])) {
            $filename .= '_'.$options['color_min'];
        }
        if (isset($options['color_max'])) {
            $filename .= '_'.$options['color_max'];
        }
